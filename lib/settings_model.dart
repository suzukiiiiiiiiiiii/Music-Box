...
enum SurfaceMode { light, dark, amoled }
...
class SettingsModel extends ChangeNotifier {
  ...
  Color _accent = const Color(0xFF6FD3C7);
  ...
  Future<void> load() async {
    ...
    final prefs = _prefs!;
    _surface = SurfaceMode.values[prefs.getInt('surface') ?? 1];
    _accent = Color(prefs.getInt('accent') ?? 0xFF6FD3C7);
  ...
  void resetToDefaults() {
    ...
    _accent = const Color(0xFF6FD3C7);
